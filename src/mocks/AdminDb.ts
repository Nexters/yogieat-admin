...
export const RESTAURANT_SEED: RestaurantDetail[] = [
	{
		...
		timeSlot: "BOTH",
		teamRecommendationTitle: "요기잇 팀 추천",
		teamRecommendationReason: "따뜻한 우동과 바삭한 튀김이 안정적인 선택입니다.",
		isDisplay: true,
	...
	},
	{
		...
		timeSlot: "LUNCH",
		teamRecommendationTitle: "점심 추천",
		teamRecommendationReason: "가볍게 먹기 좋은 돈까스 메뉴가 잘 갖춰져 있습니다.",
		isDisplay: true,
	...
	},
	{
		...
		timeSlot: "BOTH",
		teamRecommendationTitle: "회식 추천",
		teamRecommendationReason: "프라이빗룸이 있어 조용한 식사 자리에 적합합니다.",
		isDisplay: true,
	...
	},
	{
		...
		timeSlot: "LUNCH",
		teamRecommendationTitle: "중식 한상 추천",
		teamRecommendationReason: "짜장면과 짬뽕을 함께 고르기 좋은 중식당입니다.",
		isDisplay: false,
	...
	},
	{
		...
		timeSlot: "LUNCH",
		teamRecommendationTitle: "초밥 추천",
		teamRecommendationReason: "강남에서 다양한 회전초밥을 고르기 좋습니다.",
		isDisplay: true,
...
const toListItem = (restaurant: RestaurantDetail): RestaurantListItem => ({
	...
	isDisplay: restaurant.isDisplay,
